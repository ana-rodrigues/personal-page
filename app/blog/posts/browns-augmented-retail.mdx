...
summary: Contributed to building an innovative augmented retail experience for Browns Fashion flagship luxury boutique, improving customer and sales associate relationships, dirving conversion for products not available in-store, and contributing to the brand's recognition as a global leader in luxury retail innovation.
...
<ul className="mdx-ul">
  <li className="mdx-li">The COVID-19 pandemic rapidly accelerated e-commerce adoption, even among luxury consumers who previously favoured in-person experiences.</li>
  <li className="mdx-li">Lockdowns forced luxury brands to redirect budgets towards stronger digital strategies and invest in omnichannel experiences to maintain exclusivity and high-touch service online.</li>
  <li className="mdx-li">Farfetch and Browns identified that their luxury shoppers wanted digital convenience without sacrificing the emotional and personalised elements of boutique shopping.</li>
  <li className="mdx-li">Contexts like travel shopping were slowly regaining traction, as travelling restrictions were lifted.</li>
</ul>
...
<ul className="mdx-ul">
  <li className="mdx-li">Very important customers expect a high level of service and exclusivity that is hard to translate into an online experience.</li>
  <li className="mdx-li">Maintaining brand integrity and emotional connection is harder online; digital experiences must match the tactile, bespoke nature of luxury in-store.</li>
  <li className="mdx-li">Luxury stores manage reduced inventory (often 1–2 items per SKU), subject to rigorous sourcing rules.</li>
  <li className="mdx-li">Connecting inventory, customer data, and service across multiple channels in real time is a complex technical challenge.</li>
</ul>
...
<CustomImage src="/media/browns-1.png" alt="Technological stack overview." />
...
<CustomImage src="/media/browns-2.png" alt="Customer journey pre, during and post boutique visit." />
...
<CustomImage src="/media/browns-3.mp4" alt="Early prototype of the wishlist availability in the boutique. This was designed as an entry point to interact with the sales associate." />
...
<CustomImage src="/media/browns-4.mp4" alt="Early prototype of the smart tags interaction." />

<h3 className="mdx-h2">Post-visit product discovery</h3>
...
<CustomImage src="/media/browns-5.mp4" alt="Early prototype of the app homepage, featuring post-visit product discovery."/>
